...
export class QcoutdetailPage {
  ...
  getQC() {
    return new Promise(resolve => {
      ...
      if (this.halaman == -1) {
        ...
        this.halaman++;
        this.api.get('table/qc_out', { params: { limit: 30, offset: offsetinfopo, filter: 'order_no=' + "'" + this.orderno + "'" } })
          .subscribe(val => {
            let data = val['data'];
  ...
  doRefresh(refresher) {
    this.api.get('table/qc_out', { params: { limit: 30, filter: 'order_no=' + "'" + this.orderno + "'" } })
      .subscribe(val => {
  ...
  doUpdateChecked(result) {
    this.api.get("table/qc_out_result_parameter", { params: { filter: "qc_result_no=" + "'" + result.qc_result_no + "'" } }).subscribe(val => {
      this.qcparameter = val['data'];
      this.api.get("table/qc_out_result", { params: { filter: "qc_result_no=" + "'" + result.qc_result_no + "'" } }).subscribe(val => {
                    ...
                    this.api.post("table/qc_out_result",
                      ...
                      .subscribe(val => {
                        this.getNextNoQCResultParam().subscribe(val => {
                          ...
                          const headers = new HttpHeaders()
                            .set("Content-Type", "application/json");
                          this.api.post("table/qc_out_result_parameter",
                            {
                                              ...
                                              .subscribe(val => {
                                                this.getNextNoQCResultParam().subscribe(val => {
                                                  ...
                                                  this.api.post("table/qc_out_result_parameter",
                                                    ...
                                                    { headers })
                                                    .subscribe(val => {
                                                      this.api.get("table/qc_out_result_parameter", { params: { filter: "qc_result_no=" + "'" + this.nextnoqcresult + "'" } }).subscribe(val => {
                                                        this.qcparameter = val['data'];
  ...
  doOffChecking() {
    this.functionality = false;
    this.api.get("table/qc_out_result"/*, { params: { filter: 'qc_no=' + "'" + this.quality_control[0].qc_no + "'" } }*/).subscribe(val => {
  ...
  getQCResult(qc) {
    return new Promise(resolve => {
      this.api.get("table/qc_out_result", { params: { filter: 'qc_no=' + "'" + qc.qc_no + "'" } }).subscribe(val => {
        this.qcresult = val['data'];
        this.totaldataqcresult = val['count'];
        resolve();
      })
  ...
  doOpenContent(qcparam, noqcresult, uuidresult) {
    this.api.get("table/qc_out_result", { params: { filter: 'qc_result_no=' + "'" + noqcresult + "'" } }).subscribe(val => {
      this.qcresult = val['data'];
      this.totaldataqcresult = val['count'];
      this.param = qcparam.qc_param_desc
      this.functionality = this.functionality ? false : true;
      this.api.get("table/qc_out_result_parameter", { params: { filter: "qc_result_param_no=" + "'" + qcparam.qc_result_param_no + "'" } }).subscribe(val => {
  ...
  doSaveQCDesc(qcparam) {
    ...
    this.api.put("table/qc_out_result_parameter",
      {
      ...
      .subscribe(
        (val) => {
          this.presentToast("Save Successfully");
          this.functionality = this.functionality ? false : true;
          this.api.get("table/qc_out_result_parameter", { params: { filter: "qc_result_no=" + "'" + qcparam.qc_result_no + "'" } }).subscribe(val => {
            this.qcparameter = val['data'];
  ...
  getNextNoQC() {
    return this.api.get('nextno/qc_out/qc_no')
  }
  getNextNoQCResult() {
    return this.api.get('nextno/qc_out_result/qc_result_no')
  }
  getNextNoQCResultParam() {
    return this.api.get('nextno/qc_out_result_parameter/qc_result_param_no')
  }
}